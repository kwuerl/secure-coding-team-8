...
Both applications do not use 302 requests with the \code{Location} header in conjunction with GET parameters. Therefore no HTTP splitting/smugglin is possible.
\clearpage