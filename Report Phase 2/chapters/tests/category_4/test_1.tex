...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \textbf{Recommen\-dations} & Disable directory listing for hiding sensitive information. \\
    \textbf{CVSS} &
        \setlength{\intextsep}{0cm}
        \begin{tabular}[t]{ | l | l |}\hline
            Attack Vector           & \textcolor{red}{Network} \\ \hline
            Attack Complexity       & \textcolor{red}{Low} \\ \hline
            Privileges Required     & \textcolor{red}{None} \\ \hline
            User Interaction        & \textcolor{red}{None} \\ \hline
            Scope                   & \textcolor{Green}{Unchanged} \\ \hline
            Confidentiality Impact  & \textcolor{red}{High} \\ \hline
            Integrity Impact        & \textcolor{Green}{None} \\ \hline
            Availability Impact     & \textcolor{Green}{None} \\ \hline
        \end{tabular}
    \\ \hline
\end{longtable}
