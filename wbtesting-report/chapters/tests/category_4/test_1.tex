...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \\ \hline
    \textbf{Observation} & Generally speaking, files can be downloaded from and directory listing is enable for all folders with three exceptions. Accessing files in the folders \code{controller}, \code{model} and \code{view} shows a blank page. For example you can download the main c-file for the parser via the link \code{http://IP\_ADDRESS/\allowbreak Online Banking/\allowbreak parser/main.c}. Although the page shows "not permitted", the browser lets the user save the file. \\
