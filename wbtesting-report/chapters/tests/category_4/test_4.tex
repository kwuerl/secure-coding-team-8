...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \\ \hline
    \textbf{Observation} & It was observed that Smart Card Simulator can be downloaded directly through the URL \code{http://\allowbreak<IP-address>Online Banking/SCS/SCS.jar} without being logged in to the application. Though nothing can be done without the pin and user's credentials, the simulator can be used as a test object to observe the TANs generated and create future attacks.\\
    \textbf{Discovery} &
