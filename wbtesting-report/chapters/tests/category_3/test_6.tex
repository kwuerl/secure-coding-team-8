...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \textbf{Observation} & No settings related to caching were found in the server configuration. However, the HTTP responses contained the header \code{Cache-Control: must-revalidate, pre-check=0, post-check=0, no-store, no-cache}, which relates to the Apache module \code{mod_expires}. It is also found that sensitive data is not saved anywhere throughout the application. \\
