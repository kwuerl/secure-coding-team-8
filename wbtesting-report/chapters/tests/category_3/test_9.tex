...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \textbf{Observation} & Password change functionality has been provided to the user though which user receives a link to reset password through email. This can be an issue if the registered email id is known to the attacker. \\
