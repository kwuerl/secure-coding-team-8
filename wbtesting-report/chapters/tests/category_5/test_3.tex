...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \textbf{Discovery} &
       ...
       \begin{itemize}
           ...
           \item Open the link \code{http://<IP-address>/InternetBanking/employee.php?\allowbreak action=accounts}. Verify that we are now signed in as Administrator without entering any credentials.
       \end{itemize}
    \\
