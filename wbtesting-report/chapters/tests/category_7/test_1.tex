...
\begin{longtable}{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \textbf{Observation} & 
    	...
    	\begin{itemize}
		  \item \textbf{Application Errors:} 
			  ...
			  \item MySQL Errors are tried to be presented as \code{mysql\_errno()}. Unfortunately this is a invalid syntax.
    ...
    \textbf{Discovery} &
        ...
        In most cases in \code{DataAccess.php} the Syntax used (\code{die(mysql\_errno())}) is wrong and causes a php syntax error.
