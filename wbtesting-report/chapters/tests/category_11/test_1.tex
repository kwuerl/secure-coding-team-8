...
\begin{itemize}
    \item \textbf{Deviations from Application Requirements}
        \begin{itemize}
            ...
            \item The Batch transfer functionality does not work as expected. Upon upload of any file, the error message \code{Negative transactions not allowed} is displayed.
        \end{itemize}
