...
\begin{longtable}[l]{ p{2.3cm} | p{.79\linewidth} }\hline
    ...
    \textbf{Discovery} & The code was manually inspected and a check was enforced using the constant \code{_MAX_ALLOWED_BALANCE_INITIALIZATION} that was set to \code{50000} in the file \code{parameters.php} \\
